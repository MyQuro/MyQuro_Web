...
export default function SettingsPage() {
  ...
  if (loadingFullData) return <div className="h-[60vh] flex flex-col items-center justify-center text-center">
    ...
    <h2 className="text-xl font-bold text-white bg-black/40">Loading Settings...</h2>
    <p className="text-zinc-500 mt-2">Fetching your restaurant details</p>
  </div>;
  ...
  if (!permissions?.canManageSettings) {
    return (
      <div className="h-[60vh] flex flex-col items-center justify-center text-center">
        <div className="bg-[#d5b263]/10 p-6 rounded-full mb-4"><AlertCircle className="w-10 h-10 text-[#d5b263]" /></div>
        <h2 className="text-xl font-bold text-white bg-black/40">Settings Restricted</h2>
        <p className="text-zinc-500 mt-2">Only owners and managers can update restaurant details.</p>
      </div>
    );
  }
    ...
    <div className="max-w-6xl mx-auto space-y-6 pb-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-white bg-black/40">Restaurant Settings</h1>
        ...
        <button
          ...
          className="w-full sm:w-auto flex items-center justify-center px-8 py-3 bg-[#d5b263] text-white rounded-2xl font-bold shadow-lg shadow-red-100 hover:bg-[#c4a152] transition-all active:scale-95 disabled:opacity-70 disabled:cursor-not-allowed"
        >
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* 1. Brand Identity */}
        <section className="bg-[#0c0c0e]/80 border border-white/5 shadow-2xl rounded-3xl overflow-hidden">
          <div className="px-4 sm:px-6 py-4 border-b border-white/5 bg-gradient-to-r from-[#0c0c0e]/90 to-[#0c0c0e]/50 flex items-center gap-3">
            <div className="w-8 h-8 bg-[#d5b263]/10 rounded-lg flex items-center justify-center">
              <Utensils className="w-4 h-4 text-[#d5b263]" />
            </div>
            <h2 className="font-bold text-white bg-black/40 text-lg">Brand Identity</h2>
          </div>
          <div className="p-4 sm:p-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-2 lg:col-span-2">
              ...
              <input 
                required
                className="w-full px-4 py-3 rounded-xl border border-zinc-800 focus:ring-2 focus:ring-[#d5b263]/40 focus:border-transparent outline-none transition-all text-white placeholder:text-zinc-650 bg-black/40"
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider">Restaurant Type</label>
              <div className="relative">
                <button
                  type="button"
                  onClick={() => setShowTypeDropdown(!showTypeDropdown)}
                  className="w-full px-4 py-3 rounded-xl border border-zinc-800 focus:ring-2 focus:ring-[#d5b263]/40 outline-none bg-black/45 flex items-center justify-between hover:border-gray-300 transition-colors text-left"
                >
                  <div className="flex items-center gap-2">
                    <Building2 className="w-4 h-4 text-gray-400" />
                    <span className={form.restaurantType ? 'text-white bg-black/40' : 'text-gray-400'}>
                ...
                {showTypeDropdown && (
                  <div className="absolute z-50 mt-2 w-full bg-[#0c0c0e]/95 border border-white/10 shadow-2xl rounded-2xl max-h-64 overflow-y-auto">
                    {RESTAURANT_TYPES.map(type => (
                      <button
                        ...
                        className={`w-full px-4 py-3 text-left hover:bg-[#d5b263]/10 transition-colors ${
                          form.restaurantType === type ? 'bg-[#d5b263]/10 text-[#d5b263] border border-[#d5b263]/20 font-bold' : 'text-white bg-black/40'
                        }`}
                      >
                        {type}
                      </button>
            ...
            <div className="space-y-2 lg:col-span-2">
              ...
              <textarea
                rows={3}
                className="w-full px-4 py-3 rounded-xl border border-zinc-800 focus:ring-2 focus:ring-[#d5b263]/40 outline-none transition-all text-white placeholder:text-zinc-650 bg-black/40 resize-none"
            ...
            {/* Cuisine Tags */}
            <div className="space-y-2 lg:col-span-2">
              <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider">Cuisine Types</label>
              <div className="flex flex-wrap gap-2 mb-3">
                {form.cuisine.map((tag, index) => (
                  <span key={index} className="inline-flex items-center gap-1 px-3 py-1 bg-[#d5b263]/10 text-[#d5b263] border border-[#d5b263]/20 rounded-full text-sm font-medium">
                    {tag}
                    <button
                      type="button"
              ...
              <input
                className="w-full px-4 py-3 rounded-xl border border-zinc-800 focus:ring-2 focus:ring-[#d5b263]/40 outline-none transition-all text-white placeholder:text-zinc-650 bg-black/40"
                value={cuisineInput}
        ...
        <section className="bg-[#0c0c0e]/80 border border-white/5 shadow-2xl rounded-3xl overflow-hidden">
          <div className="px-4 sm:px-6 py-4 border-b border-white/5 bg-gradient-to-r from-[#0c0c0e]/90 to-[#0c0c0e]/50 flex items-center gap-3">
            <div className="w-8 h-8 bg-[#d5b263]/10 rounded-lg flex items-center justify-center">
              <Upload className="w-4 h-4 text-[#d5b263]" />
            </div>
            <div className="flex-1">
              <h2 className="font-bold text-white bg-black/40 text-lg">Visual Identity</h2>
              <p className="text-xs text-zinc-500 mt-0.5">Upload your restaurant logo and banner</p>
            </div>
          </div>
          <div className="p-4 sm:p-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <section className="bg-[#0c0c0e]/80 border border-white/5 shadow-2xl rounded-3xl overflow-hidden">
          <div className="px-4 sm:px-6 py-4 border-b border-white/5 bg-gradient-to-r from-[#0c0c0e]/90 to-[#0c0c0e]/50 flex items-center gap-3">
            ...
            <div className="flex-1">
              <h2 className="font-bold text-white bg-black/40 text-lg">Location & Contact</h2>
              <p className="text-xs text-zinc-500 mt-0.5">Manage your address and contact information</p>
            </div>
          </div>
          <div className="p-4 sm:p-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="lg:col-span-2 space-y-2">
              <label htmlFor="restaurantAddress" className="text-xs font-bold text-zinc-500 uppercase tracking-wider flex items-center gap-2">
              ...
              <div className="relative">
                <input 
                  ...
                  disabled
                  className="w-full px-4 py-3 rounded-xl border border-zinc-800 bg-zinc-900/40 text-zinc-400 cursor-not-allowed outline-none"
            ...
            {/* City - READ ONLY */}
            <div className="space-y-2">
              <label htmlFor="city" className="text-xs font-bold text-zinc-500 uppercase tracking-wider flex items-center gap-2">
                <Lock className="w-3 h-3" />
                City (Protected)
              </label>
              <input 
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                <label htmlFor="state" className="text-xs font-bold text-zinc-500 uppercase tracking-wider flex items-center gap-1">
                  <Lock className="w-3 h-3" />
                  State
                </label>
                <input 
              ...
              <div className="space-y-2">
                <label htmlFor="postalCode" className="text-xs font-bold text-zinc-500 uppercase tracking-wider flex items-center gap-1">
                  <Lock className="w-3 h-3" />
                  Zip
                </label>
                <input 
            ...
            <div className="lg:col-span-2 space-y-4 border-t border-white/5 pt-6 mt-2">
              <h3 className="text-sm font-bold text-white bg-black/40 flex items-center gap-2">
                <MapPin className="w-4 h-4 text-[#d5b263]" />
              ...
              <div className="flex items-center gap-3 bg-zinc-900/40 p-4 rounded-xl border border-white/5">
                <input
                  type="checkbox"
                  id="enforceProximity"
                  className="w-4.5 h-4.5 text-[#d5b263] border-gray-300 rounded focus:ring-[#d5b263]/40"
                  checked={form.enforceProximity}
                  onChange={e => setForm({...form, enforceProximity: e.target.checked})}
                />
                <div className="space-y-0.5">
                  <label htmlFor="enforceProximity" className="text-xs font-bold text-zinc-300 uppercase tracking-wider cursor-pointer">
              ...
              {form.enforceProximity && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="space-y-2">
                    <label htmlFor="latitude" className="text-xs font-bold text-zinc-500 uppercase tracking-wider">
                      Latitude
                    </label>
                    <input 
                      id="latitude"
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-zinc-800 focus:ring-2 focus:ring-[#d5b263]/40 outline-none transition-all text-white text-sm bg-black/40"
                      value={form.latitude}
                  ...
                  <div className="space-y-2">
                    <label htmlFor="longitude" className="text-xs font-bold text-zinc-500 uppercase tracking-wider">
                      Longitude
                    </label>
                    <input 
                      id="longitude"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="geofenceRadius" className="text-xs font-bold text-zinc-500 uppercase tracking-wider">
                  ...
                  <div className="md:col-span-3 flex justify-end">
                    <button
                      ...
                      className="px-4 py-2 border border-zinc-800 text-zinc-300 font-semibold rounded-xl text-xs hover:bg-zinc-900/40 transition-colors flex items-center gap-2"
                    >
            ...
            <div className="lg:col-span-2">
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4 flex gap-3">
                <Info className="w-5 h-5 text-blue-450 flex-shrink-0 mt-0.5" />
                <div className="space-y-1">
                  <p className="text-sm font-bold text-blue-300">Address Change Request</p>
                  <p className="text-xs text-blue-400 leading-relaxed">
                    To update your restaurant address, please contact our support team at{' '}
                    <a href="mailto:support@myquro.com" className="underline font-bold hover:text-blue-300">
                      support@myquro.com
                    </a>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center border border-zinc-800 rounded-xl focus-within:ring-2 focus-within:ring-red-500 transition-all">
                ...
                <input 
                  type="tel"
                  className="flex-1 px-3 py-3 outline-none text-white bg-black/40"
            ...
            <div className="space-y-2">
              ...
              <input 
                ...
                className="w-full px-4 py-3 rounded-xl border border-zinc-800 focus:ring-2 focus:ring-[#d5b263]/40 outline-none transition-all text-white bg-black/40"
                value={form.website}
            ...
            <div className="space-y-2 lg:col-span-2">
              <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider">Total Seating Capacity</label>
              <input 
                type="number"
                min="1"
                className="w-full px-4 py-3 rounded-xl border border-zinc-800 focus:ring-2 focus:ring-[#d5b263]/40 outline-none transition-all text-white bg-black/40"
        ...
        <section className="bg-[#0c0c0e]/80 border border-white/5 shadow-2xl rounded-3xl overflow-hidden">
          <div className="px-4 sm:px-6 py-4 border-b border-white/5 bg-gradient-to-r from-[#0c0c0e]/90 to-[#0c0c0e]/50 flex items-center gap-3">
            ...
            <div className="flex-1">
              <h2 className="font-bold text-white bg-black/40 text-lg">Compliance & Tax</h2>
              <p className="text-xs text-zinc-500 mt-0.5">Legal and tax registration details</p>
            </div>
          </div>
          <div className="p-4 sm:p-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider flex items-center gap-2">
                ...
                >
                  <Info className="w-3.5 h-3.5 text-gray-400 hover:text-zinc-400 transition-colors" />
              ...
              <div className="relative">
                <input 
                  disabled
                  className="w-full px-4 py-3 rounded-xl border border-zinc-800 bg-zinc-900/40 text-zinc-400 cursor-not-allowed outline-none font-mono"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input 
                  disabled
                  className="w-full px-4 py-3 rounded-xl border border-zinc-800 bg-zinc-900/40 text-zinc-400 cursor-not-allowed outline-none pr-10"
      ...
      {showConfirmDialog && (
        <div className="fixed inset-0 bg-black/20 bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-[#0c0c0e]/95 backdrop-blur-2xl border border-white/10 rounded-3xl p-6 max-w-md w-full shadow-2xl text-white">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-[#d5b263]/10 rounded-full flex items-center justify-center">
                <AlertCircle className="w-5 h-5 text-[#d5b263]" />
              </div>
              <h3 className="text-lg font-bold text-white bg-black/40">Confirm Changes</h3>
            </div>
            ...
            <div className="flex gap-3">
              <button
                onClick={cancelSave}
                className="flex-1 px-4 py-3 border border-zinc-800 text-zinc-300 rounded-xl font-medium hover:bg-zinc-900/40 transition-colors"
              >
                Cancel
              </button>
              <button
                onClick={confirmSave}
                disabled={loading}
                className="flex-1 px-4 py-3 bg-[#d5b263] text-white rounded-xl font-bold hover:bg-[#c4a152] transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
              >
                {loading ? 'Saving...' : 'Save Changes'}
              </button>
            </div>
...
function SkeletonLoader() {
  return (
    <div className="h-[calc(100vh-5rem)] flex flex-col items-center justify-center">
      ...
      <p className="mt-3 text-sm text-zinc-500 font-medium animate-pulse">Loading Settings...</p>
    </div>
  )
}